<?php
	...
	class User_model extends CI_Model 
	{
		...
		function add_user($username, $password, $nation_name) 
		{
			...
			$this->db->insert('nation_info', array('nation_name' => $nation_name, 'nation_ruler' => $username, 'nation_team_colour' => 'None', 'nation_alliance_affiliation' => 'None', 'nation_infrastructure' => 1, 'nation_technology' => 1, 'nation_land' => 1, 'nation_religion' => 'None', 'nation_government' => 'Democracy', 'nation_funds' => 10000, 'nation_soldiers' => 1, 'nation_tax_rate' => 10, 'nation_nuclear_weapons' => 0, 'nation_tanks' => 0, 'nation_average_income' => 100, 'nation_citizens' => 1, 'nation_citizens_density' => 1, 'nation_collected_taxes' => FALSE, 'nation_paid_bills' => FALSE, 'nation_developed_nuclear_weapon' => FALSE, 'nation_planes' => 0, 'nation_resource_one' => $resourceone, 'nation_resource_two' => $resourcetwo, 'nation_changed_religion' => FALSE, 'nation_improvement_bank' => 0));
